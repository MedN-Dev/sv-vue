...
<script>
  ...
  export default {
    ...
    props: ['category', 'region', 'fit', 'codYears'],
    data () {
      return {
        pageSize: 10,
        totalCount: 100,
    ...
    methods: {
      infiniteHandler($state) {
        this.$axios.get(Portfolio.Projects, { id: this.category, region: this.region, fit: this.fit, codYears: this.codYears, page: this.page, pageSize: this.pageSize })
        .then((res)=>{
